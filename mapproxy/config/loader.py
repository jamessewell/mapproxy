...
class CacheConfiguration(ConfigurationBase):
    ...
    def _s3_cache(self, grid_conf, file_ext):
        ...
        max_pool_connections = self.context.globals.get_value('cache.max_pool_connections', self.conf,
            global_key='cache.s3.max_pool_connections')
